    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-slate-500">
          Start planning your perfect family vacation
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-sm sm:rounded-lg sm:px-10 border border-slate-200">
                ...
                {passwordRequirements.map((req, index) => (
                  <div key={index} className="flex items-center text-sm">
                    {req.valid ? (
                      ...
                      <AlertCircleIcon className="h-4 w-4 text-slate-300 mr-2" />
                    )}
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <a href="/login" className="ml-1 font-medium text-blue-500 hover:text-blue-600">
              Sign in instead
            </a>
          </div>
        </div>
